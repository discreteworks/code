...
int main() {
  ...
  std::cin >> find_num;
  node *found = find(root, find_num);
  if (found != nullptr)
    std::cout << "found node:" << found->data << std::endl;
  else
    std::cout << "not found" << std::endl;
  node *found_rec = find_recursive(root, find_num);
  if (found != nullptr)
    std::cout << "found node using recursion:" << found->data << std::endl;
  else
    std::cout << "not found using recursion" << std::endl;
}
